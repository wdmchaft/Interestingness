...
-(void)applicationDidFinishLaunching:(UIApplication *)application{
	tableViewController=[[InterestingnessTableViewController alloc] 
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Interestingness" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Interestingness.sqlite"];
